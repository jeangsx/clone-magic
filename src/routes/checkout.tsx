...
export default function CheckoutPage() {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <p style={{ color: "#333" }}>
            Recibirás un correo con los detalles de tu envío. Gracias por confiar en ProstaGenix.
          </p>
          <Link
            to="/"
            style={{
  ...
  return (
    ...
    >
      ...
      >
        <Link to="/" style={{ color: BLUE, fontWeight: 900, fontSize: 24, textDecoration: "none" }}>
      ...
      >
        ...
        >
          ...
          <h2 style={{ marginTop: 24, color: BLUE, fontWeight: 900, fontSize: 20 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginTop: 14 }}>
            {(["card", "paypal"] as const).map((k) => (
              <button
                ...
                onClick={() => setPay(k)}
                style={{
                  border: `2px solid ${pay === k ? BLUE : "#e3e6ee"}`,
                  background: pay === k ? "#eef3fb" : "#fff",
                  borderRadius: 10,
                  padding: "12px",
                  cursor: "pointer",
                  fontWeight: 800,
        ...
        >
          ...
          >
            <img
              src="https://www.prostagenix.com/images/product/bottle_box.png"
              alt=""
