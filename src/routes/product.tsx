      ...
      >
        ...
        <section>
          ...
          <div style={{ marginTop: 18, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            {[
              { icon: "💤", title: "Sueño Reparador", desc: "Reduce las visitas nocturnas al baño" },
              { icon: "⚡", title: "Acción Rápida", desc: "Resultados visibles en 2-4 semanas" },
              { icon: "🌿", title:  "100% Natural", desc: "Sin químicos ni efectos secundarios" },
              { icon: "🔬", title: "Clínicamente Probado", desc: "Estudios respaldan su eficacia" },
            ].map((b) => (
              <div
                key={b.title}
                style={{
              ...
              >
                ...
                <div style={{ fontWeight: 800, fontSize: 13, color: "#0b1a3a" }}>{b.title}</div>
                <div style={{ fontSize: 12, color: "#666", marginTop: 2 }}>{b.desc}</div>
              </div>
            ))}
          </div>
          ...
          >
            <div style={{ fontWeight: 900, fontSize: 16, color: BLUE, marginBottom: 14 }}>
              Ingredientes Activos
            </div>
            {[
              {
                name: "Saw Palmetto (320mg)",
                desc: "Bloquea la 5-alfa reductasa, reduciendo el DHT que agranda la próstata.",
                pct: 90,
              },
              {
                name: "Zinc (25mg)",
                desc: "Regula hormonas y fortalece el sistema inmunológico de la próstata.",
                pct: 85,
              },
              {
                name: "Extracto de Ortiga (120mg)",
                desc: "Antiinflamatorio natural que alivia la presión sobre la vejiga.",
                pct: 80,
              },
              {
                name: "Licopeno (10mg)",
                desc: "Antioxidante que protege las células de la próstata del daño oxidativo.",
                pct: 75,
              },
            ].map((ing) => (
              <div key={ing.name} style={{ marginBottom: 14 }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                  <span style={{ fontWeight: 700, fontSize: 13, color: "#0b1a3a" }}>{ing.name}</span>
                  <span style={{ fontSize: 12, color: BLUE, fontWeight: 700 }}>{ing.pct}%</span>
                </div>
                <div
                  style={{
                    height: 6,
                ...
                <div style={{ fontSize: 12, color: "#666" }}>{ing.desc}</div>
              </div>
            ))}
          </div>
          ...
          >
            ...
            {[
              { step: "1", title: "Absorción Rápida", desc: "Las cápsulas se disuelven y los ingredientes activos entran al torrente sanguíneo." },
              { step: "2", title: "Bloqueo de DHT", desc: "El Saw Palmetto bloquea la conversión de testosterona a DHT, causante del agrandamiento." },
              { step: "3", title: "Alivio Real", desc: "En 2-4 semanas: menos nocturia, mejor flujo urinaria y mayor comodidad." },
            ].map((s) => (
          ...
          >
            <img
              src="https://www.prostagenix.com/images/home/dudley-danoff.png"
              alt="Video"
            ...
            >
              Mira cómo ProstaGenix funciona
            </div>
          </div>
          ...
          >
            ...
            <div style={{ fontWeight: 900, fontSize: 14, color: BLUE }}>Fabricado en EE.UU.</div>
            <div style={{ fontSize: 12, color: "#555", marginTop: 4 }}>
              en instalaciones certificadas GMP · Laboratorio verificado por third-party
            </div>
          </div>
